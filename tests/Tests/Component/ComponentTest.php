...
class ComponentTest extends \TestCaseDatabase
{
	...
	public function testGetModelReturnsFrontendModel()
	{
		...
		$this->assertEquals('UsersModelRegistration', get_class($component->model('Registration')));
	}

	/**
	 * Test that model throws an exception if model is not found.
	 *
	 * @return  void
	 *
	 * @expectedException \InvalidArgumentException
	...
	{
		$component = Component::get('com_content');
		$this->assertEquals('ContentModelArticles', get_class($component->model('Unknown')));
	}

	/**
	 * Test that model throws an exception if model has no models folder.
	 *
	 * @return  void
	 *
	...
	public function testGetModelNoModelsFolderException()
	{
		...
		$this->assertEquals('AjaxModelUnknown', get_class($component->model('Unknown')));
	}
	...
	{
		$component = Component::get('com_categories')->admin();
		$table = $component->table('Inexistent');
	}
